...
dat_2011 <- inner_join(dat2011, PKEYcombo[,2:3], by=c("SS")) #n=151379
...
dat_2001 <- inner_join(dat2001, PKEYcombo[,2:3], by=c("SS")) #n=151379
...
cdat3 <- inner_join(cdat2, PKEYcombo[,2:3], by=c("SS")) #n=152483
