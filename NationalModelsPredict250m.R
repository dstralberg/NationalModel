...
#ROOT3 <- "H:/My Drive/BAM.SharedDrive/RshProjs/PopnStatus/NationalModelsV4.0/May2020/" #output predictions
ROOT3 <- "H:/My Drive/nationalmodel250/"
...
SPP3 <- c("WOTH")
SPP4 <- c("NESP", "LEYE", "GCTH", "FOSP", "WCSP")
