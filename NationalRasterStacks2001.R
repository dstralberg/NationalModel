...
writeRaster(biomass, file=paste(w,"bs2001_1km",sep=""))
...
# roughness <- raster("F:/GIS/topoedaphic/rough1k.tif")
...
for (i in 1:length(bcrs)){
  ...
  writeRaster(bs,file=paste(w,gsub("_100km","",bcrs[i]),"_2001_1km",sep=""),overwrite=TRUE)
}
